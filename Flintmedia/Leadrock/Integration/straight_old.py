...
class IntegrationLeadrock(unittest.TestCase):
    ...
    #Url parsing
        straight = byxpath('//*[@id="subscribe-list"]/table/tbody/tr[4]/td[2]').text
        if "Прямая старая" in straight:
            straight_url = byxpath('//*[@id="subscribe-list"]/table/tbody/tr[4]/td[5]/span').text
    ...
    #Ыекфшпре landing + checking lead availability
